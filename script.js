document.addEventListener("DOMContentLoaded", () => {
  ...
  const chapters = {
    ...
    biology: [
      { name: "» Biological classification", url: "Biology/each-chp-qType/biomolecules-qType.html" },
      ...
      { name: "» Plant kingdom", url: "Biology/each-chp-qType/biomolecules-qType.html" },
